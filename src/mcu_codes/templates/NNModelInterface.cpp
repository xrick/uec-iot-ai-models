...
#define TEST_MODEL_06_085_PRUNING			1
// #define TEST_MODEL_RETRAIN_95_4				1
//#define TEST_UEC_ALARM_MODEL 					1

#if defined(TEST_MODEL_06_085_PRUNING)
#include "acdnet_model_0.6_0.85pruning_95.4.cc"
#elif defined(TEST_MODEL_RETRAIN_95_4)
...
constexpr int kTensorArenaSize = g_arena_size +10000 ; // - 10000; //+10000;
